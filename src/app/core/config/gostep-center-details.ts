export const GoSteps_Center_Details = [
  {
    ...
    seo: {
      description:
        'goSTOPS Bir is a workation located in the jaw dropping destination offers Bed Mix Dorm and Deluxe Double Ensuite Room with 7, 15, 22 and 30 days packages.',
  ...
  // Rishikesh ===============================
  {
    ...
    seo: {
      description:
        'goSTOPS Rishikesh is a peaceful workation offers Bed Mix Dorm & Deluxe Double Ensuite Room with 7, 15, 22 & 30 days package and equipped with present-day facilities.',
  ...
  // Udaipur =================================
  {
    ...
    seo: {
      description:
        'goSTOPS Udaipur is a quirky workation offers Bed Mix Dorm Ensuite and Deluxe Double Ensuite Room with 7, 15, 22 and 30 days package arrangements.',
  ...
  // McLoadGanj ==============================
  {
    ...
    seo: {
      description:
        'goSTOPS McleodGanj is a breathtaking workation offers Bed Mix Dorm & Deluxe Double Ensuite Room for 7, 15, 22 & 30 days. Believe us & live an unforgettable lifestyle.',
  ...
  // Kochi ===================================
  {
    ...
    seo: {
      description:
        'goSTOPS Kochi is a gorgeously designed workation offers Bed Mix Dorm & Deluxe Double Ensuite Room with top-notch facilities & all packages of 7, 15, 22 & 30 days.',
  ...
  // Manali ==================================
  {
    ...
    seo: {
      description:
        'goSTOPS Manali is a heaven living destination offers Bed Mix Dorm Ensuite and Deluxe Double Ensuite Room with latest amenities and features.',
  ...
  // Jaipur =================================================
  {
    ...
    seo: {
      description:
        'goSTOPS Jaipur is an artistic workation offers Bed Mix Dorm Ensuite and Deluxe Double Ensuite Room with present-day amenities and features. Book your accommodation today!',
  ...
  // Mumbai =================================================
  {
    ...
    seo: {
      description:
        'goSTOPS Mumbai is a mind-blowing workation offers Bed Mix Dorm Ensuite and Deluxe Double Ensuite Room with 7, 15, 22 and 30 days packages.',
  ...
  // Amritsar =================================================
  {
    ...
    description:
      'goSTOPS Amritsar is the perfect rental accommodation offering beautiful, comfortable and affordable places to stay with friends and family in Amritsar. It has Mixed Dorm Ensuites and Deluxe Double Ensuite Rooms available on from 7days to 30 days stay package. This beautifully constructed rental living accommodation is located within walking distance from the Golden Temple. There are unlimited modern-day amenities such as warm water, safe drinking water, chilling areas, cosy beds, 24*7 Cafe, workspace and free wifi connection and much more. You deserve a safe, comfortable and luxurious stay with your loved ones. Book your stay with us and you will remember it for a lifetime, we bet! ',
    location: {
    ...
    seo: {
      description:
        'goSTOPS Amritsar is the perfect rental accommodation offering Mixed Dorm Ensuites and Deluxe Double Ensuite Rooms available on from 7days to 30 days stay package.',
  ...
  // Alleppey =================================================
  {
    ...
    seo: {
      description:
        'goSTOPS Alleppey is a well-designed rental accommodation for tourists, backpackers, solo travellers with Deluxe Double Ensuite Rooms fitted with top-notch amenities.',
  ...
  // Munnar =================================================
  {
    ...
    seo: {
      description:
        'Book well-designed Mixed Dorm Ensuites and Deluxe Double Ensuite Rooms in goSTOPS Munnar Hostel with stay options from 7 to 30 days.',
  ...
  // Palampur =================================================
  {
    ...
    seo: {
      description:
        'Book your stay with goSTOPS Palampur having cost-effective Mixed Dorm Ensuites and Deluxe Double Ensuite Rooms with flexible plans from 7 to 30 days.',
  ...
  // Dalhousie =================================================
  {
    ...
    seo: {
      description:
        'goSTOPS Dalhousie is one of the most affordable &  elegant rental accommodations offering Mixed Dorm & Deluxe Double Ensuite Rooms at a very reasonable price.',
  ...
  // Leh =================================================
  {
    name: 'goSTOPS Leh',
    description:
      'Your inner wanderlust is driving you crazy and you want to get transported directly to Leh, right? We value your wanderlust and that’s why we want to offer you a safe and comfortable stay with goSTOPS Leh. It is a well-designed and delightful rental living accommodation offering Mixed Dorm Ensuites and Deluxe Double Ensuite Rooms. This well-constructed rental staying accommodation comes along with modern-day amenities such as 24*7 Café, Free Filtered Water, Fast Speed WiFi connectivity, Chillout Areas, Working Space, Hot Water and much more. Enjoy crazy views, homely towns, scenic roads and so much more. Different stay packages from 7 days to 30 days are available. You may choose any of the plans which fits in your budget and convenience.',
    location: {
    ...
    seo: {
      description:
        'goSTOPS Leh is a well-designed and delightful rental living accommodation offering Mixed Dorm Ensuites and Deluxe Double Ensuite Rooms with modern-day amenities.',
  ...
  // Mussoorie =================================================
  {
    ...
    seo: {
      description:
        'Book your stay with goSTOPS Mussoorie located on Library Road, Uttrakhand. It provides affordable Mixed Dorm Ensuites and Deluxe Double Ensuite Rooms for group travelers as well as for solo travelers.',
  ...
  // Nagger =================================================
  {
    ...
    seo: {
      description:
        'If you’re planning to visit Naggar in Himachal Pradesh, goSTOPS Naggar is the best rental living accommodation with Mixed Dorm & Deluxe Double Ensuite Rooms.',
  ...
  // Delhi =================================================
  {
    ...
    seo: {
      description:
        'Located in Daryaganj, goSTOPS Delhi is backpackers’ favourite living accommodation. It offers Mixed Dorm & Deluxe Double Ensuite Rooms with top-notch amenities.',
