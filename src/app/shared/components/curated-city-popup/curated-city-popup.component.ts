...
export class CuratedCityPopupComponent implements OnInit {
  ...
  constructor(private bsModalRef: BsModalRef, private workSpaceService: WorkSpaceService) { }
  ...
  ngOnInit() {
    ...
    if (
      ...
      this.price === '625698d3a91948671a4c590b' ||
      this.price === '625698e8a91948671a4c590c'
    ) {
